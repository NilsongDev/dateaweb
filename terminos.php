...
if (isset($_SESSION['emailuser'])) {
    ...
    $passwordEncryp = password_hash($emailuser,PASSWORD_BCRYPT);
...
<body>
    ...
    <div class=" flex justify-center  h-screen">
        ...
        <br>
        <div>
            <h4 class="mb-4 text-4xl tracking-tight leading-none  md:text-5xl lg:text-6xl text-blue-600 dark:text-blue-500"></h4>
            <h3 class="mb-4 text-4xl tracking-tight leading-none   text-blue-600 dark:text-blue-500">Los terminos y condiciones de esta plataforma esta asociados a un prototipo base, el cual su contenido o uso es confidencial.</h3>          
