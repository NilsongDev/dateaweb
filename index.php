                        ...
                        ?>
                                <li class="splide__slide">
                                    <div class="cardperfil"><img src="componentes/images/perfil_user.jpg" alt="ichabod">
                                        <div class="cardperfil-detalles"><strong>Nombre: <?php echo $row["nombreuser"] . "" . $row["apellidouser"]; ?></strong><span></span><br><span>Ciudad: <?php echo $row["comunausuario"]; ?> <br> Ofico: <?php echo  $row["nombre_oficio"];?> <br> telefono: <?php echo  $row["telefonouser"];?> </span></div>
                                    </div>
                                </li>
            ...
            <div class="splide__slider">
                ...
                <ul class="splide__list">
                        ...
                        ?>
                                <li class="splide__slide">
                                    <div class="cardperfil"><img src="componentes/images/perfil_user.jpg" alt="ichabod">
                                        <div class="cardperfil-detalles"><strong>Nombre: <?php echo $row["nombreuser"] . "" . $row["apellidouser"]; ?></strong><span><br> Ciudad: <?php echo $row["comunausuario"]; ?> <br> Oficio: <?php echo $row["nombre_oficio"];?> <br> Telefono: <?php echo $row["telefonouser"];?></span></div>
                                    </div>
                                </li>
