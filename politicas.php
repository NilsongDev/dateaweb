...
<body>
    ...
    <div class="flex justify-center">
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none  md:text-5xl lg:text-6xl text-blue-600 dark:text-blue-500">POLITICAS</h1>
    </div>
    ...
    <div class=" flex justify-center  h-screen">
        ...
        <br>
        <div>
            <h4 class="mb-4 text-4xl tracking-tight leading-none  md:text-5xl lg:text-6xl text-blue-600 dark:text-blue-500"> :D</h4>
