...
<body>
    ...
    <div class=" flex justify-center  h-screen">
        ...
        <br>
        <div>
            <h4 class="mb-4 text-2xl tracking-tight leading-none  md:text-5xl lg:text-6xl text-blue-600 dark:text-blue-500">Si necesitas alguna ayuda contactate al siguiente correo datea.conce@gmail.com </h4>
